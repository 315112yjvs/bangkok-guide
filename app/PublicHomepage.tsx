...
const ADDR_ALIASES: [string, string][] = [
  ...
  ['bang na', 'Sukhumvit'], ['on nut', 'Sukhumvit'], ['udom suk', 'Sukhumvit'],
  ['bearing', 'Sukhumvit'], ['phra khanong', 'Sukhumvit'], ['phrakanong', 'Sukhumvit'],
  ['klong toey', 'Sukhumvit'],
  ['silom', 'Silom'], ['si lom', 'Silom'], ['bang rak', 'Silom'], ['bangrak', 'Silom'],
  ['phra ram', 'Silom'], ['rama iv', 'Silom'], ['rama 4', 'Silom'],
  ['chong nonsi', 'Silom'], ['surasak', 'Silom'], ['saphan taksin', 'Silom'],
  ...
  ['lad phrao', 'Ratchada'], ['din daeng', 'Ratchada'],
  ['huai khwang', 'Ratchada'], ['huay khwang', 'Ratchada'],
  ['chatuchak', 'Chatuchak'], ['jatujak', 'Chatuchak'], ['jj market', 'Chatuchak'],
  ['bang sue', 'Chatuchak'], ['don mueang', 'Chatuchak'],
  ['yaowarat', 'Yaowarat'], ['chinatown', 'Yaowarat'], ['china town', 'Yaowarat'],
  ['phra nakhon', 'Yaowarat'], ['rattanakosin', 'Yaowarat'],
  ['pom prap', 'Yaowarat'], ['pomprap', 'Yaowarat'], ['samphanthawong', 'Yaowarat'],
  ['chakkrawat', 'Yaowarat'], ['wang burapha', 'Yaowarat'],
  ['pom prap sattru phai', 'Yaowarat'], ['boripat', 'Yaowarat'], ['ban bat', 'Yaowarat'],
  ['ari', 'Ari'], ['phahon yothin', 'Ari'],
  ['lumphini', 'Silom'],
  ['ratchathewi', 'Pratunam'], ['makkasan', 'Pratunam'],
  ['pratunam', 'Pratunam'],
  ['victory monument', 'Victory Monument'], ['ratchawithi', 'Victory Monument'],
  ['phaya thai', 'Victory Monument'],
  ['bang kho laem', 'Riverside'], ['bangkholaem', 'Riverside'],
  ['khlong san', 'Riverside'], ['thon buri', 'Riverside'],
  ['charoen krung', 'Riverside'], ['charoen nakhon', 'Riverside'],
  ['wat phraya krai', 'Riverside'],
]
...
const AREA_BOUNDS: { name: string; latMin: number; latMax: number; lngMin: number; lngMax: number }[] = [
  ...
  { name: 'Victory Monument',  latMin: 13.754, latMax: 13.780, lngMin: 100.525, lngMax: 100.548 },
  { name: 'Pratunam',          latMin: 13.745, latMax: 13.762, lngMin: 100.531, lngMax: 100.550 },
