...
export const CATEGORY_META: Record<string, CollectionMeta> = {
  cafe: {
    slug: 'cafe', emoji: '☕', icon: 'local_cafe',
  ...
  food: {
    slug: 'food', emoji: '🍜', icon: 'restaurant',
  ...
  nightlife: {
    slug: 'nightlife', emoji: '🍸', icon: 'local_bar',
  ...
  shopping: {
    slug: 'shopping', emoji: '🛍️', icon: 'shopping_bag',
  ...
  attraction: {
    slug: 'attraction', emoji: '🗺️', icon: 'attractions',
